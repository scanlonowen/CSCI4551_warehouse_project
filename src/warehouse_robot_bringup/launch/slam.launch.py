...
Drive the robot around, then save the map with:
    ros2 run nav2_map_server map_saver_cli -f ~/warehouse_ws/src/warehouse_robot_bringup/maps/warehouse
"""
...
def generate_launch_description():
    ...
    slam_params = os.path.join(bringup_pkg, 'config', 'slam_toolbox_async.yaml')
